  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          <h3>Bienvenido al Sistema de inventarios Creado por SC 🥳</h3>
          <p>
            Perfectamente diseñado para su negocio <br> Ponga en marcha esta aplicacion y simpllifique sus procesos.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <p class="mb-4">Por favor inicie sesion con su cuenta registrada</p>
        ...
        <div class="divider my-4">
          <div class="divider-text">Visitanos</div>
        </div>
